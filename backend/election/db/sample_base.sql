...
ADD CONSTRAINT fk_candidate_id_ballot FOREIGN KEY (user_id) REFERENCES candidates(user_id);
...
ADD CONSTRAINT fk_candidate_id_result FOREIGN KEY (candidate_id) REFERENCES candidates(user_id);
